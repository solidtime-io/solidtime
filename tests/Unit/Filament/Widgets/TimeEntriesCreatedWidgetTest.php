...
#[UsesClass(TimeEntriesCreated::class)]
class TimeEntriesCreatedWidgetTest extends ChartWidgetTestCase
{
    public function test_widget_renders_with_filters(): void
    {
        // Act
        $response = Livewire::test(TimeEntriesCreated::class);

        // Assert
        $response->assertSuccessful();
        $response->assertSee('Time Entries Created');
    ...
    public function test_counts_only_non_imported_time_entries_created_in_the_last_week_by_default(): void
    {
        // Arrange
        TimeEntry::factory()->createMany([
            ['created_at' => now()->subDay(), 'is_imported' => false],
        ...
        $this->assertSame('Time Entries Created', $data['datasets'][0]['label']);
    ...
    public function test_month_filter_counts_time_entries_created_in_the_last_month_per_day(): void
    {
        ...
        TimeEntry::factory()->createMany([
            ...
            ['created_at' => now()->subMonths(2), 'is_imported' => false],
        ]);
    ...
    public function test_year_filter_counts_time_entries_created_in_the_last_year_per_month(): void
    {
        ...
        TimeEntry::factory()->createMany([
            ...
            ['created_at' => now()->subYears(2), 'is_imported' => false],
        ]);
