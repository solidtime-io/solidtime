...
return [
    ...
    */
    ...
    'after_or_equal' => ':attribute alanı :date tarihine eşit veya ondan sonra bir tarih olmalıdır.',
    ...
    'before_or_equal' => ':attribute alanı :date tarihine eşit veya ondan önce bir tarih olmalıdır.',
    'between' => [
    ...
    */
    ...
    'color' => ':attribute alanı geçerli bir renk olmalıdır.',
    'currency' => ':attribute alanı geçerli bir para birimi kodu olmalıdır (ISO 4217).',
    'organization' => ':attribute mevcut değil.',
    'task_belongs_to_project' => ':attribute verilen projeye ait değil.',
    'project_name_already_exists' => 'Aynı isim ve istemciye sahip bir proje organizasyonda zaten mevcut.',
    'tag_name_already_exists' => 'Aynı isme sahip bir etiket organizasyonda zaten mevcut.',
    'client_name_already_exists' => 'Aynı isme sahip bir istemci organizasyonda zaten mevcut.',
    'task_name_already_exists' => 'Aynı isme sahip bir görev projede zaten mevcut.',
    'invitation_already_exists' => 'E-posta zaten organizasyona davet edildi. Lütfen kullanıcının daveti kabul etmesini bekleyin veya davet e-postasını tekrar gönderin.',
