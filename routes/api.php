...
Route::prefix('v1')->name('v1.')->group(static function () {
    Route::middleware([
        ...
        // Member routes
        Route::name('members.')->prefix('/organizations/{organization}')->group(static function () {
        ...
        // Invitation routes
        Route::name('invitations.')->prefix('/organizations/{organization}')->group(static function () {
            ...
            Route::post('/invitations/{invitation}/resend', [InvitationController::class, 'resend'])->name('resend');
            Route::delete('/invitations/{invitation}', [InvitationController::class, 'destroy'])->name('destroy');
        });

        // Project routes
        Route::name('projects.')->prefix('/organizations/{organization}')->group(static function () {
        ...
        Route::name('project-members.')->prefix('/organizations/{organization}')->group(static function () {
            Route::get('/projects/{project}/project-members', [ProjectMemberController::class, 'index'])->name('index');
            Route::post('/projects/{project}/project-members', [ProjectMemberController::class, 'store'])->name('store');
            Route::put('/project-members/{projectMember}', [ProjectMemberController::class, 'update'])->name('update');
            Route::delete('/project-members/{projectMember}', [ProjectMemberController::class, 'destroy'])->name('destroy');
        });

        // Time entry routes
        Route::name('time-entries.')->prefix('/organizations/{organization}')->group(static function () {
            ...
            Route::post('/time-entries', [TimeEntryController::class, 'store'])->name('store');
            Route::put('/time-entries/{timeEntry}', [TimeEntryController::class, 'update'])->name('update');
            Route::patch('/time-entries', [TimeEntryController::class, 'updateMultiple'])->name('update-multiple');
        ...
        // Report routes
        Route::name('reports.')->prefix('/organizations/{organization}')->group(static function () {
        ...
        // Tag routes
        Route::name('tags.')->prefix('/organizations/{organization}')->group(static function () {
        ...
        // Client routes
        Route::name('clients.')->prefix('/organizations/{organization}')->group(static function () {
        ...
        // Task routes
        Route::name('tasks.')->prefix('/organizations/{organization}')->group(static function () {
        ...
        // Import routes
        Route::name('import.')->prefix('/organizations/{organization}')->group(static function () {
    ...
    // Public routes
    Route::name('public.')->prefix('/public')->group(static function () {
